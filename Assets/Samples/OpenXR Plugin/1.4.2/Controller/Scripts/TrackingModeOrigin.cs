...
namespace UnityEngine.XR.OpenXR.Samples.ControllerSample
{
    ...
    {
        [SerializeField]
        private Image m_RecenteredImage = null;

        [SerializeField]
        private Color m_RecenteredOffColor = Color.red;

        [SerializeField]
        private Color m_RecenteredColor = Color.green;

        [SerializeField]
        private float m_RecenteredColorResetTime = 1.0f;
        ...
        { get { return m_CurrentTrackingOriginMode; } }

        [SerializeField]
        private Text m_CurrentTrackingOriginModeDisplay = null;

        [SerializeField]
        private TrackingOriginModeFlags m_DesiredTrackingOriginMode;

        public TrackingOriginModeFlags desiredTrackingOriginMode
        { get { return m_DesiredTrackingOriginMode; } set { m_DesiredTrackingOriginMode = value; } }
        ...
        { get { return m_SupportedTrackingOriginModes; } }
